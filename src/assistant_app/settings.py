"""
Django settings for assistant_app project.
...
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql', # shows that we use Postgres DB
...
# Налаштування аутентифікації Django (якщо потрібні)
...
# Використовуємо консольний бекенд для тестування
EMAIL_BACKEND = "django.core.mail.backends.console.EmailBackend"

EMAIL_HOST = "smtp.gmail.com"  # Не використовується, але залишаємо для реального використання
EMAIL_PORT = 587
EMAIL_USE_TLS = True
